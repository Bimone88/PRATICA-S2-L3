const starWarsCharacters = [
  ...
  */
    for(let i = 0; i < starWarsCharacters.length; i++) {
        ...
        charactersNames.push(names) // pusho nell'array i nomi
     }
  ...
  */
    const eyeColor = {
      ...
      console.log("eyeColor.blue" , eyeColor.blue)
      console.log("eyeColor.yellow" , eyeColor.yellow)
      console.log("eyeColor.brown" , eyeColor.brown)
      console.log("eyeColor.red" , eyeColor.red)
      console.log("eyeColor['blue-gray']" , eyeColor['blue-gray'])
